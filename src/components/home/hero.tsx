            ...
            >
              ...
              <Box sx={{ mb: 4, width: { xs: '100%', md: '70%' } }}>
                <Typography sx={{ color: 'text.secondary', lineHeight: 1.6 }}>
                  {
                    'Ashoka is a strong community of 4000+ alum. Imagine what would happen if every member of the network came together to support student-scholarships. Our collective efforts can encourage students to dream big, regardless of their financial situation.'
                  }
                </Typography>
              </Box>
              <Box sx={{ '& button': { mr: 2 } }}>
